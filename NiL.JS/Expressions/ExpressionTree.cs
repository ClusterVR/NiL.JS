                ...
                case '-':
                {
                    ...
                    if (state.Code[i + 1] == '-')
                    {
                        ...
                        if (state.Strict)
                        {
                            if ((first is Variable)
                                && ((first as Variable).Name == "arguments" || (first as Variable).Name == "eval"))
                                ExceptionHelper.Throw(new SyntaxError("Cannot decriment \"" + (first as Variable).Name + "\" in strict mode."));
                        }
                ...
                switch (state.Code[i])
                {
                    case '+':
                    {
                        ...
                        if (state.Code[i] == '+')
                        {
                            ...
                            {
                                ExceptionHelper.ThrowSyntaxError("Cannot incriment \"" + (operand as Variable).Name + "\" in strict mode.", state.Code, i);
                            }
                    ...
                    case '-':
                    {
                        ...
                        if (state.Code[i] == '-')
                        {
                            ...
                            if (state.Strict
                                && (operand is Variable)
                                && ((operand as Variable).Name == "arguments" || (operand as Variable).Name == "eval"))
                                ExceptionHelper.Throw(new SyntaxError("Cannot decriment \"" + (operand as Variable).Name + "\" in strict mode."));
